...
* Style the the sign-in page to look like the mock (ui_signin.png). 
...
* Implement client side validation for both forms.
  ...
  * If the form has any invalid fields, the form should not submit.

* Style the signed-in page (the page with the list of users) to look like the mock (ui_app.png). Change the markup where necessary.
...
* Clicking the x in a notification should hide the notification.
...
* Styling the user profile pages.
